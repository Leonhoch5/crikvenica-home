export const villas = [
    {
        name: "Villa Ivanka",
        descriptions: {
            en: "One Bedroom. One Pool. No One Else.",
...
Im Jahr 1895 erbaut, wurden die Häuser 2008 mit viel Liebe fürs Detail restauriert und renoviert. Dabei war uns sehr wichtig den autochthonen Charakter der Gebäude zu erhalten und das Traditionelle mit der Moderne und dem heutigen Komfort zu verbinden. Die Häuser sind mit den antiken Möbeln ausgestattet, die die traditionelle Akzente setzen. Sie müssen jedoch nicht auf den technischen Komfort verzichten. Wir möchten Sie höflichst bitten, mit diesen Familienstücken, die uns sehr am Herzen liegen, aufmerksam umzugehen.
...
Che si tratti di colazione sulla terrazza, di un tuffo in piscina o del tramonto sul mare, Villa Ivanka offre una fuga silenziosa in cui si incontrano patrimonio e comfort.`,
    ...
    },
    {
        name: "Villa Milka",
        descriptions: {
            en: "A Family Retreat Behind Stone Walls",
        ...
        longDescriptions: {
            en: `Just three kilometres from the beaches and lively promenade of Crikvenica, Villa Milka offers the peace of the countryside with sweeping views across Kvarner Bay and the island of Krk. Surrounded by stone walls and Mediterranean gardens, it is a welcoming retreat for families looking to slow down, relax, and enjoy time together.

Originally built in 1895 and carefully restored in 2007, the villa combines the authentic character of a traditional stara primorska kuća with modern comfort. Original stone walls, exposed timber beams, and carefully chosen antique furnishings create a warm, homely atmosphere, while central heating and air conditioning ensure year-round comfort.

The large enclosed garden is designed with families in mind. Children have plenty of space to play safely, while adults can unwind beside the private 6 × 4 metre swimming pool. A covered terrace with a traditional barbecue, long wooden dining table, sun loungers, and an outdoor shower provides the perfect setting for relaxed afternoons and long summer evenings overlooking the olive grove.

The villa comfortably accommodates four to six guests across two floors and a converted loft.

On the ground floor, a bright sea-facing living room opens onto a fully equipped kitchen and dining area. The comfortable sofa can accommodate two additional guests if required, and a guest WC is tucked neatly beneath the staircase.

A wooden staircase leads to the first floor, where two double bedrooms enjoy beautiful sea views. One bedroom features a romantic freestanding bathtub beside the window, while the second has an en-suite bathroom with a shower and WC.

The converted loft provides a third bedroom with twin or double beds, together with its own shower and toilet, making it an ideal space for older children, teenagers, or another couple.

A cosy room in the original basement offers a quiet corner for reading, games, or simply escaping with a good book. At the front of the house, an intimate stone courtyard connects the villa to the pool terrace and Mediterranean garden, creating several inviting spaces to relax throughout the day.

Private parking is available beside the villa, and fragrant rosemary, lavender, olive trees, and other native Mediterranean plants surround the property, completing the authentic atmosphere of Croatia's Kvarner coast.`,
            de: `Villa Milka ist ein friedlicher Rückzugsort hinter Steinmauern und bietet weite Blicke über die Kvarner Bucht und die Insel Krk. Etwas oberhalb von Crikvenica gelegen, verbindet die Villa die Ruhe des Landlebens mit der Nähe zur Küste und ist ideal für Familien, die entspannen und gemeinsam Zeit verbringen möchten.

Die 1895 erbaute und 2007 sorgfältig restaurierte Villa verbindet den authentischen Charakter einer traditionellen stara primorska kuća mit modernem Komfort. Originale Steinmauern, freiliegende Holzbalken und sorgfältig ausgewählte Antiquitäten schaffen eine warme, heimelige Atmosphäre, während Zentralheizung und Klimaanlage das ganze Jahr über für Komfort sorgen.

Der große, geschlossene Garten ist speziell für Familien gedacht. Kinder haben viel Platz zum sicheren Spielen, während Erwachsene am privaten 6 × 4 Meter großen Pool entspannen können. Eine überdachte Terrasse mit traditionellem Grill, langem Holztisch, Sonnenliegen und Außendusche bietet den perfekten Rahmen für entspannte Nachmittage und lange Sommerabende mit Blick auf den Olivenhain.

Die Villa bietet vier bis sechs Gästen komfortabel Platz auf zwei Etagen und einem ausgebauten Dachgeschoss.

Im Erdgeschoss öffnet sich ein helles, zum Meer ausgerichtetes Wohnzimmer zu einer voll ausgestatteten Küche und einem Essbereich. Das bequeme Sofa kann bei Bedarf zwei weitere Gäste aufnehmen, und ein Gäste-WC ist platzsparend unter der Treppe untergebracht.

Eine Holztreppe führt in das Obergeschoss, wo zwei Doppelzimmer einen schönen Meerblick genießen. Ein Schlafzimmer verfügt über eine romantische freistehende Badewanne neben dem Fenster, das zweite über ein en-suite Badezimmer mit Dusche und WC.

Das ausgebaute Dachgeschoss bietet ein drittes Schlafzimmer mit Einzel- oder Doppelbetten sowie eigener Dusche und Toilette und eignet sich ideal für ältere Kinder, Teenager oder ein weiteres Paar.

Ein gemütlicher Raum im originalen Keller bietet eine ruhige Ecke zum Lesen, Spielen oder einfach zum Zurückziehen mit einem guten Buch. Vor dem Haus verbindet ein intimer Steinhof die Villa mit der Poolterrasse und dem mediterranen Garten und schafft mehrere einladende Orte zum Entspannen.

Privater Parkplatz steht direkt neben der Villa zur Verfügung, und duftender Rosmarin, Lavendel, Olivenbäume und andere mediterrane Pflanzen umgeben das Anwesen und vollenden die authentische Atmosphäre der Kvarner Küste.`,
...
Davanti alla casa c’è un piacevole cortile con un’ulteriore stanza che può essere utilizzata come sala giochi. Da lì si accede direttamente alla piscina, accanto alla quale si trova un’ampia zona coperta con posti a sedere e camino/barbecue. Il parcheggio è accanto alla casa e un giardino mediterraneo con piante locali completa l’atmosfera tranquilla.`,
    ...
    },
    {
        name: "Villa Vesna",
        descriptions: {
            en: "Where Family and Friends Come Together",
        ...
        longDescriptions: {
            en: `Set on a peaceful hillside above Crikvenica, Villa Vesna is a beautifully restored stone villa designed for families and groups of friends who want to enjoy time together without giving up their own space. Arranged across several levels, the villa offers privacy, character, and spectacular views across Kvarner Bay and the island of Krk.

Originally built in 1895 and carefully restored in 2008, Villa Vesna preserves the authentic charm of a traditional stara primorska kuća while offering every modern comfort. Original stone walls, exposed wooden beams, colourful fabrics, and carefully selected artwork create warm and inviting interiors that feel both elegant and relaxed.

The villa accommodates up to eight guests in four air-conditioned double bedrooms. Each bedroom has its own en-suite bathroom and beautiful views of the Adriatic Sea. Two bedrooms are located on the raised ground floor, with an identical layout on the upper floor, allowing everyone to enjoy privacy while still sharing the spaces that bring people together.

From the courtyard, you enter directly into the comfortable living room with satellite TV and DVD player. A staircase leads to the raised ground floor, where two bedrooms are arranged on either side of a central hallway, each with its own bathroom.

Halfway between the floors, the house opens into a charming traditional dining room centred around an original open fireplace. This warm and welcoming space is the heart of the villa, perfect for long dinners and relaxed evenings together. The fully equipped kitchen opens directly onto a spacious covered terrace with a barbecue, where many summer evenings naturally continue.

A staircase leads further to the upper floor, where two additional double bedrooms offer the same beautiful sea views and private en-suite bathrooms.

A hidden treasure of the villa is the original wine cellar, now transformed into a cosy lounge and TV area. Cool and quiet, it provides a comfortable retreat during warm summer afternoons.

Outside, Mediterranean gardens surround a private 8 × 4.5 metre swimming pool with a solar shower, sun loungers, and a shaded terrace overlooking the Adriatic. The covered outdoor dining area with a traditional barbecue is the perfect place to enjoy fresh local food, a glass of Croatian wine, and unforgettable evenings beneath the stars.

Private parking is available beside the villa. Lavender, rosemary, olive trees, and other native Mediterranean plants complete the peaceful atmosphere of this unique stone retreat on Croatia’s Kvarner coast.`,
